...
**Gültig ab**: 02.08.2024  
**Dokumenttyp**: Gesetz  
**Quelle**: Land Baden-Württemberg  
**Fundstelle**: GBl. 2024, Nr. 66  
...
- **ERSTER ABSCHNITT**: Aufgabe, Trägerschaft und Durchführung des Rettungsdienstes (§§ 1-5)
- **ZWEITER ABSCHNITT**: Organisation und Einrichtungen des Rettungsdienstes (§§ 6-28)
- **DRITTER ABSCHNITT**: Genehmigungsverfahren (§§ 29-36)
- **VIERTER ABSCHNITT**: Pflichten der Unternehmerin oder des Unternehmers (§§ 37-39)
- **FÜNFTER ABSCHNITT**: Finanzierung des Rettungsdienstes (§§ 40-44)
- **SECHSTER ABSCHNITT**: Luft-, Berg- und Wasser-Rettungsdienst (§§ 45-46)
- **SIEBTER ABSCHNITT**: Aufsicht, Datenschutz (§§ 47-58)
- **ACHTER ABSCHNITT**: Ordnungswidrigkeiten, Schlussvorschriften (§§ 59-61)

**Wichtige Kernpunkte:**

**Organisationsstruktur:**
- Landesausschuss für den Rettungsdienst (§ 8) - zentrale Beratung und bindende Vorgaben
- Bereichsausschüsse (§ 10) - Planung und Regelung auf Rettungsdienstbereichsebene
- Zentrale Stelle für Qualitätssicherung (§ 9) - trägerübergreifende Qualitätssicherung
- Integrierte Leitstellen (§§ 11-13) - Notrufannahme, Disposition, Lenkung aller Einsätze
- Ärztliche Leitungen Rettungsdienst (§ 5) - medizinische Beratung und Standards

**Planung und Zeitvorgaben:**
- Eintreffzeit: max. 12 Minuten in 95% der Fälle (§ 6 Absatz 2)
- Prähospitalzeit: max. 60 Minuten in 80% für bestimmte Notfälle
- Bereichspläne: jährlich zu überprüfen und bei Bedarf fortzuschreiben

**Personal und Qualifikation:**
- Rettungswagen: Notfallsanitäter/in + mind. Rettungssanitäter/in (§ 16)
- Notarzteinsatzfahrzeug: Notarzt/Notärztin + Rettungsassistent/in oder Notfallsanitäter/in
- Jährliche Fortbildungspflicht: mindestens 30 Stunden
- Ärztliche Verantwortliche im Rettungsdienst für eigenständige heilkundliche Maßnahmen (§ 20)

**Moderne Versorgungskonzepte:**
- Digitaler Versorgungsnachweis (§ 11 Absatz 6) - Kapazitätsübersicht Krankenhäuser
- Telenotärztliches System (§ 2 Nr. 15) - Ferndiagnostik und -behandlung
- Helfer-vor-Ort-Systeme (§ 23) - Organisierte Erste Hilfe
- App-alarmierte Ersthelfer (§ 24) - Smartphone-basierte Alarmierung

**Trägerschaft:**
- Notfallrettung: Leistungsträger nach Landesvereinbarungen (ASB, DRK, JUH, MHD, etc.)
- Krankentransport: Leistungsträger + private Unternehmen mit Genehmigung
- Luftrettung: Träger ist das Land Baden-Württemberg

**Datenschutz:**
- Umfangreiche Regelungen (§§ 49-58) für alle Beteiligten
- Speicherfristen: i.d.R. 10 Jahre für Einsatzdokumentationen
- Qualitätssicherungsdaten: 15 Jahre bei Zentraler Stelle

**Besonderheiten:**
- Experimentierklausel (§ 7) zur Erprobung neuer Versorgungskonzepte
- Ausnahmen bei besonderen Gesundheitslagen (§ 17) - z.B. Pandemie
- Grenzüberschreitender Rettungsdienst (§ 28)
- Öffentliche Förderung von Rettungswachen bis 90% (§ 40)

**Umsetzungsfristen:**
- Digitaler Versorgungsnachweis: bis 31.12.2025 vollständig betriebsbereit
- Telenotärztliches System: bis 31.12.2025 in definierten Bereichen, bis 31.12.2030 landesweit
- Planungsvorgaben nach § 6: Umsetzung bis 31.12.2030
...
**Schnittstellen Feuerwehr:**
- Technische Hilfe bei Rettungsdiensteinsätzen durch Feuerwehr (§ 25)
- Wasserrettung bleibt Aufgabe der Feuerwehr nach FwG (§ 3 Absatz 3)
- Integrierte Leitstellen in gemeinsamer Trägerschaft (§ 12)
- Vertretung der Feuerwehr im Bereichsausschuss (§ 10)

**Neue Standards:**
- Klare Zeitvorgaben für Notfallrettung
- Digitalisierung (Versorgungsnachweis, Telenotarzt)
- Qualitätssicherung als Querschnittsaufgabe
- Moderne Personalbesetzungskonzepte
