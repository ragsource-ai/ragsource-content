---
titel: "Verwaltungsvorschrift der Landesregierung und der Ministerien zur Bildung von Stäben bei Außergewöhnlichen Einsatzlagen und Katastrophen (VwV Stabsarbeit)"
ebene: land
saule: regelungsrahmen
rechtsnatur: verwaltungsvorschrift
land_ars: "08"
land: Baden-Württemberg
quelle: "GABl. 2024, 234"
gueltig_ab: 2024-06-01
gueltig_bis: 2031-05-31
url: "https://www.landesrecht-bw.de/bsbw/document/VVBW-VVBW000041316"
beschreibung: "Einrichtung und Arbeit von Führungsstäben bei außergewöhnlichen Ereignissen."
stand: "2026-03-27"
status: published
projekte:
  - amtsschimmel
...
- Anlage 1: Muster Personalmatrix
- Anlage 2: Muster Alarmierungsverzeichnis
- Anlage 3: Muster Erreichbarkeitsverzeichnis
- Anlage 4: Aufgaben- und Funktionsbeschreibung Vb 2
- Anlage 5: Stabsdienstordnung
- Anlage 6: Muster Tagebuch
- Anlage 7: Empfehlung zur Vorbereitung und Ausstattung von Stabsräumen
- Anlage 8: Beispiele für fachlich überwiegende Ressortzuständigkeiten

### 1 Allgemeines

Eine professionelle und effiziente Gefahrenabwehr und ein zielgerichtetes Krisenmanagement verlangen nach einem schnellen, planvollen und koordinierten Zusammenwirken sowie einem einheitlichen Führungsverständnis aller Beteiligten und auf allen Entscheidungsebenen. Mit dieser Verwaltungsvorschrift wird eine durchgängige Organisationsform zur Bewältigung solcher Ereignisse beschrieben. Sie berücksichtigt zugleich die von der Ständigen Konferenz der Innenminister und -senatoren (IMK) am 21. November 2003 gebilligten bundeseinheitlichen »Hinweise zur Bildung von Stäben der administrativ-organisatorischen Komponente (Verwaltungsstäbe VwS)«.
...
Zur Bewältigung komplexer, großräumiger und länger andauernder Schadenereignisse, wie zum Beispiel Außergewöhnlicher Einsatzlagen sowie im Katastrophenfall ist die unmittelbare Leitung durch die politisch-gesamtverantwortliche Instanz erforderlich.
...
- a) Politisch Gesamtverantwortliche = Behördenleitung
- b) Administrativ-organisatorischer Bereich = Verwaltungsstab
- c) Operativ-taktischer Bereich = Führungsstab

Die oder der politisch Gesamtverantwortliche (im Folgenden Behördenleitung, vergleiche Nummer 3.2.1, zum Beispiel: Ministerin oder Minister, Regierungspräsidentin oder Regierungspräsident, Oberbürgermeisterin oder Oberbürgermeister, Landrätin oder Landrat, Bürgermeisterin oder Bürgermeister) muss sowohl Verwaltungsmaßnahmen (administrativ-organisatorische Aufgaben) als auch Einsatzmaßnahmen (operativ-taktische Aufgaben) veranlassen, koordinieren und verantworten. Die Behördenleitung kann sich dafür im administrativorganisatorischen Bereich eines Verwaltungsstabs (vergleiche Nummer 3.2.3) und im operativ-taktischen Bereich eines Führungsstabs (vergleiche Nummer 9) bedienen.

Auf Ministeriumsebene werden in der Regel keine operativ-taktischen Maßnahmen veranlasst, sodass hier in der Regel kein Führungsstab einzurichten ist.
...
Die Behördenleitung beauftragt eine fachlich und persönlich geeignete Person mit der Leitung des Verwaltungsstabs (Verwaltungsstabsleitung), soweit sie nicht selbst die Leitung übernimmt. Die Verwaltungsstabsleitung veranlasst, koordiniert und steuert die Stabsarbeit und trifft die für die Lagebewältigung notwendigen politisch-strategischen Entscheidungen.
...
Die Katastrophenschutzbehörden bilden zur Erfüllung von Katastrophenschutzaufgaben besondere Führungseinrichtungen zur Erledigung der administrativ-organisatorischen Aufgaben (Verwaltungsstab) und ggf. zur Erledigung der operativ-taktischen Aufgaben (Führungsstab), in denen Vertretungen der benötigten Fachdienste sowie der durch ein Störereignis direkt betroffenen Betreiber von Anlagen mit besonderem Gefahrenpotential angemessen zu beteiligen sind.
...
- a) der Verwaltungsstabsleitung,
- b) der Koordinierungsgruppe Verwaltungsstab (KGS),
- c) vorbehaltlich des jeweiligen Zuschnitts des Geschäftsbereiches den ständigen Mitgliedern des Stabes (SMS) sowie
- d) den ereignisspezifischen Mitgliedern des Stabes (EMS).
...
- a) Vb 1 - Innerer Dienst
- b) Vb 2 - Lage und Dokumentation
- c) Vb 3 - Bevölkerungsinformation und Medienarbeit (BuMA)
- d) Vb 4 - Sicherheit und Ordnung
- e) Vb 5 - Bevölkerungsschutz

Ständige Mitglieder des Stabes (SMS)

- f) Vb 6 - Gesundheit
- g) Vb 7 - Umwelt und Energie

Ereignisspezifische Mitglieder des Stabes (EMS)

- h) Vb ff. - weitere Verwaltungsstabsbereiche entsprechend der Geschäftsverteilung der Landesregierung.
...
- b) Vb 2 - Lage und Dokumentation,
- c) Vb 3 - Bevölkerungsinformation und Medienarbeit (BuMA),
- d) Vb 4 - Sicherheit und Ordnung und
- e) Vb 5 - Bevölkerungsschutz.
...
- h) Vb 8 - Landwirtschaft, Forst, Veterinär-, Lebensmittelwesen, Markt und Ernährung,
- i) Vb 9 - Straßenwesen und Verkehr,
- j) Vb 10 - Schulwesen und
- k) Vb 11 - Wirtschaft.
...
**3.2.3.10 Lageorientierte weitere Verwaltungsstabsbereiche**

Lageabhängig können weitere lageorientierte Verwaltungsstabsbereiche (optional) aufgerufen werden.

- l) Vb 12 - Inneres (zum Beispiel Vb 12.1 - IT-Sicherheit/Cyberangriff, Vb 12.2 - Landes-IT),
- m) Vb 13 - Liegenschaften und Finanzen,
- n) Vb 14 - Justiz und Migration,
- o) Vb 15 - Hochschulwesen, Forschung und Kunst sowie
- p) Vb 16 - Landesentwicklung und Wohnen.

Die lageorientierten weiteren Verwaltungsstabsbereiche gehören zu den ereignis-spezifischen Mitgliedern des Verwaltungsstabs. Eine Beteiligung erfolgt nach Entscheidung des Aufrufs der KGS, durch die alarmierende Stelle.

**3.2.3.11 Besondere Regelung für die Verwaltungsstabsbereiche der Ministerien**
...
- b) Vb 2 - Lage und Dokumentation,
- c) Vb 3 - Bevölkerungsinformation und Medienarbeit (BuMA),
- d) Vb 8.1 - Landwirtschaft,
- e) Vb 8.2 - Forst,
- f) Vb 8.3 - Veterinär- und Lebensmittelwesen sowie
- g) Vb 8.4 - Markt und Ernährung.

Weitere fachbezogene Verwaltungsstabsbereiche orientieren sich an diesem Konzept.

**3.2.3.12 Lageorientierte weitere Verwaltungsstabsbereiche (Vb 12 - 16)**
...
**3.2.3.13 Fachberatungen und Verbindungspersonen**
...
Grundsätzlich ist der gegenseitige Austausch von Verbindungpersonen der polizeilichen und nichtpolizeilichen Gefahrenabwehr, auch in die operativ-taktischen Führungsstäbe sowie die polizeilichen Führungsstäbe, im gegenseitigen Einvernehmen, anzustreben.

**3.2.3.14 Einbindung der/des Opferbeauftragten der Landesregierung**
...
Die Verwaltungsstabsleitung entscheidet aufgrund vorliegender Informationen über die zu treffenden administrativ-organisatorischen Maßnahmen, legt Ziele fest und koordiniert die grundsätzlich eigenverantwortliche Arbeit der Verwaltungsstabsbereiche (Vb). Sie bestimmt die Gliederung des Stabes (vergleiche Nummer 3.2.3.4) und vertritt, soweit sie nichts anderes bestimmt, den Stab nach außen.
...
- a) Vb 1 - Innerer Dienst,
- b) Vb 2 - Lage und Dokumentation,
- c) Vb 3 - Bevölkerungsinformation und Medienarbeit (BuMA) und
- d) Vb X - Fach-Verwaltungsstabsbereich entsprechend Ressortzuständigkeit (Ressortabhängig).
...
- a) der Verwaltungsstabsleitung,
- b) der Koordinierungsgruppe Verwaltungsstab (KGS),
- c) den ständigen Mitgliedern des Stabes (SMS),
- d) den ereignisspezifischen Mitgliedern des Stabes (EMS)
...
- b) Vb 2 - Lage und Dokumentation,
- c) Vb 3 - Bevölkerungsinformation und Medienarbeit (BuMA),
- d) Vb 4 - Sicherheit und Ordnung sowie
- e) Vb 5 - Bevölkerungsschutz.
...
- f) Vb 6 - Gesundheit,
- g) Vb 7 - Umwelt und Energie,
- h) Vb 8 - Landwirtschaft, Forst, Veterinär- und Lebensmittelwesen, Markt und Ernährung,
- i) Vb 9 - Straßenwesen und Verkehr,
- j) Vb 10 - Schulwesen,
- k) Vb 11 - Wirtschaft,
- l) Vb 12 - Inneres (derzeit: IT-Sicherheit/Cyberangriff, Landes-IT),
- m) Vb 13 - Liegenschaften und Finanzen,
- n) Vb 14 - Justiz und Migration,
- o) Vb 15 - Hochschulwesen, Forschung und Kunst sowie
- p) Vb 16 - Landesentwicklung und Wohnen.
...
- a) gleichen oder ähnlichen besonderen Ereignissen an unterschiedlichen Orten,
- b) politisch bedeutsamen beziehungsweise öffentlichkeitswirksamen Vorfällen,
- c) (drohenden) Außergewöhnlichen Einsatzlagen oder Katastrophen,
...
- d) die für das Ereignis örtlich zuständige Behörde,
- e) die Katastrophenschutzbehörde,
- f) das örtlich zuständige regionale Polizeipräsidium und
- g) das Lagezentrum der Landesregierung oder
- h) andere im Katastropheneinsatzplan benannte Stellen.
...
Der Führungsstab koordiniert und veranlasst die operativ-taktischen Maßnahmen. Er legt hierfür insbesondere die Einsatzschwerpunkte sowie die Ordnung des Raumes, der Kräfte, der Zeit und der einsatzbezogenen Informations- und Kommunikationswege fest.
...
[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A001.pdf)

### Anlage 2: Muster Alarmierungsverzeichnis

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A002.pdf)

### Anlage 3: Muster Erreichbarkeitsverzeichnis

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A003.pdf)

### Anlage 4: Aufgaben- und Funktionsbeschreibung Vb 2

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A004.pdf)

### Anlage 5: Stabsdienstordnung

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A005.pdf)

### Anlage 6: Muster Tagebuch

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A006.pdf)

### Anlage 7: Empfehlung zur Vorbereitung und Ausstattung von Stabsräumen

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A007.pdf)

### Anlage 8: Beispiele für fachlich überwiegende Ressortzuständigkeiten

[PDF](https://www.landesrecht-bw.de/jportal/docs/anlage/vvbw/pdf/VVBW-IM-20240507-SF-A008.pdf)
