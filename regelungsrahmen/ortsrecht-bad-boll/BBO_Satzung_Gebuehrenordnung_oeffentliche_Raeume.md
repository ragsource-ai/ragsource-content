...
gemeinde: Bad Boll
quelle: Gemeinderatsbeschluss vom 21.01.2016, Stand Januar 2016
gueltig_ab: 2016-01-21
status: published
projekte:
  - amtsschimmel
keywords:
...
| Einrichtung | Berechnungseinheit | Örtl. Verein | Privatperson |
|-------------|-------------------|--------------|--------------|
| **Altes Schulhaus (Bürgersaal**), Wohnanlage am Blumhardtweg (Mehrzweckraum**)** | | | |
| | Tagessatz | 35,00 € | |
| | Stundensatz | 5,00 € | |
| **Dorfhaus Eckwälden*** | | | |
...
| | Stundensatz | 20,00 € | |
| **Sporthalle (alt)** | | | |
| | Stundensatz Erwachsene * | 6,00 € | |
| | Stundensatz Kinder/Jugendliche * | 3,00 € | |
| | Außerhalb des Vereinsübungsbetriebes: | | |
| | Tagessatz * | 75,00 €** | |
| | Stundensatz * | 10,00 €** | |
| **Sporthalle (neu)** | | | |
| | Stundensatz je Hallendrittel * | 5,00 € | |
| | Außerhalb des Vereinsübungsbetriebes: | | |
| | Tagessatz * | 150,00 €** | |
| | Stundensatz * | 20,00 €** | |
...
Auf sämtliche Gebühren wird ein **Auswärtigenzuschlag von 100 v.H.** erhoben.

**\*** zzgl. gesetzl. MwSt.

**\*\*** Es werden keine Benutzungsgebühren erhoben, wenn der Reinerlös der Veranstaltung nicht dem Veranstalter sondern einem sozialen Zweck zufließt.