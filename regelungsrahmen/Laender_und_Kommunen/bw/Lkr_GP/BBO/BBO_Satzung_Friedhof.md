...
endpoints:
  - amtsschimmel
url: "https://daten2.verwaltungsportal.de/dateien/seitengenerator/545d755504e296c7e756c08b585edfac200801/F7_-_Friedhofsatzung.pdf"
url_nachfolger:
extensions:
  - Kommunalrecht
  - Steuer- & Abgabenrecht
...
**(1)** Die Friedhöfe der Gemeinde Bad Boll werden als zwei voneinander getrennte öffentliche Einrichtungen „Friedhof Bad Boll" und „Friedhof Eckwälden" geführt. Die beiden Friedhöfe dienen der Bestattung verstorbener Gemeindeeinwohner und der in der Gemeinde verstorbenen oder tot aufgefundenen Personen ohne Wohnsitz oder mit unbekanntem Wohnsitz Verstorbener, sowie für Verstorbene, für die ein Wahlgrab nach § 12 zur Verfügung steht. In besonderen Fällen kann die Gemeinde eine Bestattung anderer Verstorbener zulassen. Die Friedhöfe dienen auch der Bestattung von Totgeburten, Fehlgeburten und Ungeborenen, falls ein Elternteil Einwohner der Gemeinde ist.

**(2)** Soweit nichts anderes bestimmt ist, gelten die Vorschriften über die Bestattung auch für die Beisetzung von Aschen.

**(3)** Das Gemeindegebiet wird in folgende Bestattungsbezirke eingeteilt:

Bestattungsbezirk des Friedhofes Bad Boll; er umfasst das Gebiet der Gemeinde Bad Boll mit Ausnahme des Ortsteiles Eckwälden.

Bestattungsbezirk des Friedhofes Eckwälden; er umfasst das Gebiet des Ortsteiles Eckwälden.
...
**(3)** Auf den Friedhöfen in Bad Boll und Eckwälden dürfen keine Zwischenwege verlegt werden. Die Zwischenwege zwischen den Gräbern werden von der Gemeinde verlegt. Die Kosten hierfür werden von der Gemeinde mit den Bestattungsgebühren erhoben.

### § 8 Ruhezeit

Die Ruhezeit der Verstorbenen beträgt 20 Jahre; bei Kindern, die vor Vollendung des 2. Lebensjahres verstorben sind, 10 Jahre.

Die Ruhezeit von Aschen beträgt 15 Jahre
...
**(2)** Auf den Friedhöfen Bad Boll und Eckwälden werden folgende Arten von Grabstätten zur Verfügung gestellt:

1. Reihengräber,
2. Wahlgräber,
3. Urnenwahlgräber,
4. Urnengemeinschaftsgräber,
5. Baumgräber für Urnenbeisetzungen,
6. Rasenreihengräber mit Gedenkplatte für Erdbestattungen,
7. Rasenreihengräber mit Gedenkplatte für Urnenbeisetzungen

Auf dem Friedhof Bad Boll werden außerdem folgende Arten von Grabstätten zur Verfügung gestellt:

8. anonyme Rasenreihengräber für Erdbestattungen,
9. anonyme Rasenreihengräber für Urnenbeisetzungen,
...
**(2)** Auf den Friedhöfen Bad Boll und Eckwälden werden ausgewiesen:
...
3. Rasenreihengrabfelder mit Gedenktafel für Erdbestattungen

auf dem Friedhof Bad Boll außerdem:

4. Anonyme Reihenrasengräber für Erdbestattungen

**(3)** In jedem Reihengrab wird nur ein Verstorbener beigesetzt. Die Gemeinde kann Ausnahmen zulassen.

**(4)** Ein Reihengrab für Erdbestattungen kann auch nach Ablauf der Ruhezeit nicht in ein Wahlgrab umgewandelt werden.
...
**(1)** Auf dem Friedhof Bad Boll wird ein Rasengrabfeld für anonyme Erd- und Urnenbestattungen (jeweils nur Reihengräber) zur Verfügung gestellt.

**(2)** Hierbei finden die Vorschriften über Grabmale und Grabeinfassungen keine Anwendung.

**(3)** Grabausstattungen jeder Art (Grabsteine, Grabeinfassungen, Schalen, sonstige Bepflanzungen usw.) sind nicht zulässig.

### § 11b Rasengräber mit Gedenktafel für Erdbestattungen

**(1)** Auf den Friedhöfen Bad Boll und Eckwälden wird ein Rasengrabfeld für Erdbestattungen (Reihengräber) zur Verfügung gestellt.

**(2)** Auf den Rasengräbern sind nur Gedenkplatten in einer Größe von 50 cm auf 35 cm und einer Stärke von 6 cm zulässig. Die Gedenkplatte ist mittig verdübelt auf einer Konsole mit den Maßen 15 cm x 15 cm, Höhe der vorderen Seite 15 cm / Höhe der hinteren Seite 25 cm anzubringen und muss dabei 10 cm über dem Boden liegen. Die Konsole muss auf der vorhandenen Fundamentbodenplatte verdübelt aufgestellt werden. Die Gedenkplatte darf nur aus Diabas, Sandstein rot oder Kalkstein Jura gelb gefertigt sein. Alle sichtbaren Seiten müssen fein geschliffen sein. Schriften und Ornamente sind frei wählbar, dürfen aber nicht größer als die Gedenktafel und nicht höher als 5 cm sein.
...
**(2)** Nutzungsrechte an Wahlgräbern werden auf Antrag auf die Dauer von 20 Jahren (Nutzungszeit) bei Erdbestattungen und 15 Jahren (Nutzungszeit) bei Urnenbeisetzungen verliehen. Sie können nur anlässlich eines Todesfalls verliehen werden. Die erneute Verleihung eines Nutzungsrechts ist nur auf Antrag möglich.
...
**(2)** Die Anzahl der Urnen die in einem Urnenwahlgrab beigesetzt werden können, richtet sich nach der Größe der Aschengrabstätte; zulässig sind 4 Urnen.
...
**(1)** Auf den Friedhöfen Bad Boll und Eckwälden wird ein Rasengrabfeld mit Gedenktafel für Urnenbestattungen (Wahlgräber) zur Verfügung gestellt. In einem Rasenurnengrab mit Gedenktafel können bis zu 2 Urnen beigesetzt werden.
...
**(1)** Auf den Friedhöfen Bad Boll und Eckwälden wird ein Urnengemeinschaftsfeld (Reihengräber) zur Verfügung gestellt.

**(2)** Die Grabanlage wird durch Dauerbegrünung einheitlich gestaltet.

**(3)** An Steinstelen werden einheitliche Bronzetafeln mit den Namen der Verstorbenen angebracht.

**(4)** Grabausstattungen jeder Art (Grabsteine, Grabeinfassungen, Schalen, sonstige Bepflanzungen usw.) sind nicht zulässig.

### § 13c Baumgräber für Urnenbeisetzungen

**(1)** Auf den Friedhöfen Bad Boll und Eckwälden stehen Baumgrabstätten für Urnenbeisetzungen zur Verfügung (Reihengräber). Vor jedem Baum wird ein Gedenkstein errichtet, an dem einheitliche Bronzeschilder mit den Daten der Verstorbenen angebracht werden.

**(2)** Die Beisetzung erfolgt ausschließlich in Bio-Urnen. Schmuckurnen bzw. Überurnen sind nicht zulässig.
...
**(1)** Auf dem Friedhof Bad Boll werden Grabfelder ohne Gestaltungsvorschriften und Grabfelder mit Gestaltungsvorschriften eingerichtet. Auf dem Friedhof Eckwälden werden Grabfelder mit Gestaltungsvorschriften eingerichtet.
...
**(6)** Auf Urnengrabstätten sind Grabmale bis zu 0,50 m² Ansichtsfläche zulässig.

**(7)** Liegende Grabmale dürfen nur flach oder flach geneigt auf die Grabstätte gelegt werden.

**(8)** Grabmale dürfen maximal 50% der Grabgröße abdecken und dürfen das Niveau der Trittplatten nicht übersteigen.
...
**(10)** Auf Rasengräbern dürfen keinerlei Grabausstattungen angebracht oder abgelegt werden.

**(11)** Die Gemeinde kann unter Berücksichtigung der Gesamtgestaltung des Friedhofs und im Rahmen Abs. 1 Ausnahmen von den Vorschriften der Absätze 2 bis 9 und auch sonstige Grabausstattungen zulassen.

### § 17 Genehmigungserfordernis

**(1)** Die Errichtung und jede Veränderung von Grabmalen bedarf der vorhergehenden schriftlichen Genehmigung der Gemeinde. Ohne Genehmigung sind bis zur Dauer von zwei Jahren nach der Bestattung oder Beisetzung provisorische Grabmale als Holztafeln bis zur Größe von 15 mal 30 cm und Holzkreuze zulässig.
...
**(2)** Die Höhe und die Form der Grabhügel und die Art ihrer Gestaltung sind dem Gesamtcharakter des Friedhofs, dem besonderen Charakter des Friedhofsteils und der unmittelbaren Umgebung anzupassen. Bei Plattenbelägen zwischen den Gräbern (§16 Abs. 9) dürfen die Grabbeete nicht höher als die Platten sein. Die Grabstätten dürfen nur mit solchen Pflanzen bepflanzt werden, die andere Grabstätten und die öffentlichen Anlagen nicht beeinträchtigen.
...
**(1)** Die Höhe der Verwaltungs- und Benutzungsgebühren richtet sich nach den als Anlage zu dieser Satzung beigefügten Gebührenverzeichnissen.
...
Die vor dem In-Kraft-Treten dieser Friedhofssatzung entstandenen Nutzungsrechte enden mit dem Ablauf der Ruhezeit des in dieser Grabstätte zuletzt Bestatteten.

### § 31 Inkrafttreten

**(1)** Diese Satzung und das neu gefasste Gebührenverzeichnis treten am 1. Januar 2022, die Änderungssatzungen am 1. Januar 2023, 27. Oktober 2023 sowie 5. Oktober 2024 in Kraft.

**(2)** Zum gleichen Zeitpunkt tritt die Friedhofsatzung vom 09.07.2015 (Friedhofsordnung und Bestattungsgebührensatzung) mit allen späteren Änderungen außer Kraft.
...
### I. Das Gebührenverzeichnis erhält folgende Fassung:
...
| 2.4 | für Tot- und Fehlgeburten | 335,00 € |
| **3.** | **Beisetzung von Aschen** | 30,00 € |
| **4.** | **für die Überlassung eines Reihengrabes** | |
| 4.1 | für Personen im Alter von 10 und mehr Jahren | 4.750,00 € |
...
| 5.1 | Für die Überlassung eines Urnenreihengrabes | 1.575,00 € |
| 5.2 | Für die Überlassung einer Grabstelle im anonymen Urnengrabfeld | 700,00 € |
| 5.3 | Für die Überlassung einer Grabstelle im Urnengemeinschaftsgrabfeld | 700,00 € |
| 5.4 | für die Überlassung einer Urnen-Grabstelle Baumbestattung | 700,00 € |
| **6.** | **für die Überlassung von besonderen Grabnutzungsrechten** | |
| 6.1 | für ein Wahlgrab als Doppelgrab | 8.000,00 € |
| 6.2 | für ein Wahlgrab als Einzelgrab | 4.750,00 € |
| 6.3 | Für ein Wahlgrab als Urnengrab | 1.575,00 € |
| 6.4 | Für ein Wahlgrab als Rasenurnengrab mit Gedenktafel | 920,00 € |
...
| 7.1 | Benutzung der Aussegnungshalle | 150,00 € |
| 7.2 | Benutzung der Leichenzelle (pro Tag) | 60,00 € |
| 7.3 | für die Reinigung und Desinfektion der Leichenzelle | 30,00 € |
| 7.4 | für das Ausgraben, Umbetten oder Tieferlegen von Urnen | 300,00 € |
| 7.5 | ein Zuschlag zu 8.4 in besonderen erschwerten Fällen | 50 % |
| 7.6 | für die Beisetzung der von auswärts überführten Gebeinen | 30,00 € |
| 7.7 | für Leichenträger je Träger | 75,00 € |
| 7.8 | dto. bei Trauerfeier in der Kirche bzw. auf dem Badfriedhof | 124,00 € |
| 7.9 | **für die Grabeinfassung** | |
|  | Doppelgrab | 357,00 € |
|  | Einzelgrab | 272,00 € |
|  | Urnengrab | 159,00 € |
|  | Kindergrab | 165,00 € |
| 7.10 | für die Gedenktafel im Urnengemeinschaftsgrabfeld | 428,40 € |
| 7.11 | Genehmigung von Grabmalen | 50,25 € |
| 7.12 | Abräumen von Rasengrabstellen mit Gedenktafel | 76,65 € |
