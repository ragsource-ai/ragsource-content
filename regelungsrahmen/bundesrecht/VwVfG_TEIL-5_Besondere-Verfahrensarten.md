---
titel: "Verwaltungsverfahrensgesetz (VwVfG) — Teil V: Besondere Verfahrensarten (§§ 63–78)"
ebene: bund
...
keywords:
  ...
  - Planfeststellung
  - Planverfahren
  - Bürgerbeteiligung Planfeststellung
  - Einspruch gegen Plan
  ...
  - PlanSiG
fragen:
  - "Wann findet ein förmliches Verwaltungsverfahren statt?"
  - "Wie läuft ein Planfeststellungsverfahren ab?"
  - "Welche Fristen gelten für Einwendungen im Planfeststellungsverfahren?"
  - "Was ist der Unterschied zwischen Planfeststellungsbeschluss und Plangenehmigung?"
  - "Welche Rechtswirkungen hat die Planfeststellung?"
  - "Wann kann auf ein Planfeststellungsverfahren verzichtet werden?"
  - "Was ist ein Verfahren über eine einheitliche Stelle?"
  - "Wie lange hat die Behörde Zeit für die Erörterung nach Ablauf der Einwendungsfrist?"
  - "Wann tritt ein Planfeststellungsbeschluss außer Kraft?"
querverweise:
...
# Verwaltungsverfahrensgesetz (VwVfG) — Teil V: Besondere Verfahrensarten
