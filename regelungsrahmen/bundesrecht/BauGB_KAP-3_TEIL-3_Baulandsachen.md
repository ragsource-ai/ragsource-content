---
titel: "Baugesetzbuch (BauGB) — Drittes Kapitel, Dritter Teil: Verfahren vor den Kammern für Baulandsachen (§§ 217–232)"
ebene: bund
...
keywords:
  ...
  - Enteignungsverfahren Rechtsschutz
  - Baulandgericht
  - Berufung Baulandsache
  - Revision Baulandsache
  - Rechtsschutz Enteignung
  - Klage Baurecht
  - Gericht Baulandsachen
  - BauGB
fragen:
  - "Was sind Baulandsachen und welches Gericht ist zuständig?"
  - "Wie kann man gegen einen Enteignungsbeschluss vorgehen?"
  - "Welche Fristen gelten für Rechtsbehelfe in Baulandsachen?"
querverweise:
  - "Baugesetzbuch (BauGB) — Erstes Kapitel, Fünfter Teil: Enteignung (§§ 85–122)"
---

# Baugesetzbuch (BauGB) — Drittes Kapitel: Sonstige Vorschriften, Dritter Teil: Verfahren vor den Kammern (Senaten) für Baulandsachen
